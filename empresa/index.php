...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>PayPal - Para empleados</title>
    ...
    <body>        
        ...
        <!-- Hero Start -->
        <section class="bg-half-170  d-table w-100" id="home" style="padding: 50px 0 !important;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                        <a href="#" class="logo-footer">
                            <img src="images/pp-white.svg" height="40" alt="">
                        </a>
                        <p class="mt-4">Somos una empresa lider a nivel mundial en transferencias electronicas. Visita Paypal.com</p>
                    </div><!--end col-->
